...
_pure_set_default pure_color_ssh_separator pure_color_light
_pure_set_default pure_color_ssh_user_normal fish_color_user
_pure_set_default pure_color_ssh_user_root pure_color_danger
